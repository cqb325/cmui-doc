define(["module", "react", "../BaseDemo", "FontIcon", "Menu", "../Code", "Switch"], function (module, React, BaseDemo, FontIcon, Menu, Code, Switch) {
    "use strict";
            ...
            value: function render() {
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            Menu,
                            { ref: "menu", style: { width: 300 }, modal: "multi", theme: "dark" },
                            React.createElement(
                                SubMenu,
                        ...
                        React.createElement(
                            "div",
                            { className: "mt-30" },
                            React.createElement(Switch, { checkedText: "dark", checked: true, unCheckedText: "light", onChange: this.switchTheme.bind(this) })
                        )
                    ),
                    React.createElement(
                        "div",
