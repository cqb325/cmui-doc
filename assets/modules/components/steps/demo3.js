                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            Steps,
                            { current: 1 },
                            React.createElement(Step, { title: "Login", icon: "user" }),
                            React.createElement(Step, { title: "Verification", icon: "address-card" }),
                            React.createElement(Step, { title: "Pay", icon: "credit-card" }),
                            React.createElement(Step, { title: "Done", icon: "smile-o" })
                        )
                    ),
                    React.createElement(
                        "div",
